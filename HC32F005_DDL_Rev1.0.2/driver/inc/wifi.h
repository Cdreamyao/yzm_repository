...
#define KEY1 		Gpio_GetIO(0,1)
#define KEY2 		Gpio_GetIO(0,2)
#define KEY3		Gpio_GetIO(1,5)
#define KEY4 		Gpio_GetIO(1,4)
#define KEY5 		Gpio_GetIO(2,3)
#define KEY_NET Gpio_GetIO(2,7)
#define KEY_BT 	Gpio_GetIO(3,1)
//#define DEBUG_PRINTF
//=============================================================================
//下发命令
//=============================================================================
...
typedef struct {
	...
	unsigned int WARM_VAL;
	unsigned int LAST_RED_VAL;
	unsigned int LAST_GREEN_VAL;
	unsigned int LAST_BLUE_VAL;
	unsigned int LAST_WHITE_VAL;
	unsigned int LAST_WARM_VAL;
	unsigned int HUE;
...
typedef struct
{
	...
	signed long int BRIGHT;
	unsigned long int COL_TEMPERATURE;
	unsigned char COLOUR_DATA[12];
	unsigned char COLOUR_DATA_UPLAOD[12];
	unsigned char SCENE_DATA[210];
	unsigned char SCENE_DATA_LOAD[210];
}DP_DEF;
...
extern FLASH_LIGHT_DATA_DEF flash_light_data;
