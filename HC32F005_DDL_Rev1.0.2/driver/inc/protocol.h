...
/******************************************************************************
                            1:修改产品信息                
******************************************************************************/
#define WIFI_PRODUCT_KEY "gccrsxckwswk3lj3"    //开发平台创建产品后生成的16位字符产品唯一标识
#define BT_PRODUCT_KEY "jynukbcr" 
...
#define WIFI_DATA_PROCESS_LMT           250              //串口数据处理缓存区大小,根据用户DP数据大小量定,必须大于24
#else
...
#define WIFIR_UART_SEND_BUF_LMT         250              //根据用户DP数据大小量定,必须大于48
/******************************************************************************
                        4:定义模块工作方式
模块自处理:
...
//开关(可下发可上报)
//备注:
#define WIFI_DPID_SWITCH_LED 20
//模式(可下发可上报)
//备注:
#define WIFI_DPID_WORK_MODE 21
//亮度值(可下发可上报)
//备注:
#define WIFI_DPID_BRIGHT_VALUE 22
//冷暖值(可下发可上报)
//备注:
#define WIFI_DPID_TEMP_VALUE 23
//彩光(可下发可上报)
//备注:
#define WIFI_DPID_COLOUR_DATA 24
//场景(可下发可上报)
//备注:
#define WIFI_DPID_SCENE_DATA 25

#define BT_DPID_SWITCH_LED 1
//模式(可下发可上报)
//备注:
#define BT_DPID_WORK_MODE 2
//亮度值(可下发可上报)
//备注:
#define BT_DPID_BRIGHT_VALUE 3
//冷暖值(可下发可上报)
//备注:
#define BT_DPID_TEMP_VALUE 4
//彩光(可下发可上报)
//备注:
#define BT_DPID_COLOUR_DATA 5
//场景(可下发可上报)
//备注:
#define BT_DPID_SCENE_DATA 6
